...
//  setTimeout(()=>console.log(state.jobs[jobId]), 10000)
</script>
<template>
          ...
          <aside>
            ...
            <div class="bg-white p-6 rounded-lg shadow-md mt-6">
              ...
              <RouterLink
                ...
                cursor-pointer rounded-full w-full focus:outline-none focus:shadow-outline mt-4 block"
                >Edit Job</RouterLink>
              <button @click="handleDelete"
                class="bg-red-500 hover:bg-red-600 text-white font-bold py-2 px-4 rounded-full w-full 
                cursor-pointer focus:outline-none focus:shadow-outline mt-4 block"
              >
                Delete Job
              </button>
            </div>
